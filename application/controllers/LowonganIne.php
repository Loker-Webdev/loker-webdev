...
class Lowongan extends CI_Controller {
	...
	public function showLowongan(){
		$movieRepository=$this->em->getRepository('Entity\Lowongan');
		$data['allLowongan']= $LowonganRepository->findby(array(), array('ID_LOWONGAN' => 'ASC'),3);
	...
	public function addLowongan()
	{
		...
		$lowongan->setUsername('Joseph');
		$lowongan->setPassword('secretPassw0rd');
		$lowongan->setNama('yoga');
		$lowongan->setEmail('josephatwildlyinaccuratedotcom');
